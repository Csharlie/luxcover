...
export function LcGallery({
  ...
  return (
    <section
      id="gallery"
      data-ui-id="section-lc-gallery"
      data-ui-component="lc-gallery"
      data-ui-role="gallery"
      className="bg-obsidian-900 text-foreground py-24 scroll-mt-16"
    >
            ...
            <button
              ...
              className={cn(
                ...
                !activeCategory
                  ...
                  : 'bg-obsidian-800 text-gray-400 border-obsidian-700 hover:text-white hover:border-gold/40',
              )}
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {pagedImages.map((image, index) => (
            <div
              ...
              className="relative aspect-square overflow-hidden cursor-pointer group rounded-xl bg-obsidian-800 border border-obsidian-700 hover:border-gold/30 transition-colors"
        ...
        {totalPages > 1 && (
          ...
          >
            <button
              ...
              className="px-4 py-2 rounded-lg text-sm font-medium bg-obsidian-800 text-gray-400 hover:text-white transition-colors disabled:opacity-30 disabled:cursor-not-allowed border border-obsidian-700"
            >
              ←
            </button>
            {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
              <button
                ...
                className={cn(
                  ...
                  currentPage === page
                    ? 'bg-gold text-obsidian-950 border-gold'
                    : 'bg-obsidian-800 text-gray-400 border-obsidian-700 hover:text-white',
                )}
              >
                {page}
              </button>
          ...
          >
            ...
            {lightboxIndex > 0 && (
              <button
                ...
                data-ui-trigger="click"
                className="absolute left-4 top-1/2 -translate-y-1/2 text-white hover:text-gold transition-colors text-4xl z-10 px-3 py-2"
            ...
            {lightboxIndex < filteredImages.length - 1 && (
              <button
                ...
                data-ui-action="navigate"
                data-ui-trigger="click"
                className="absolute right-4 top-1/2 -translate-y-1/2 text-white hover:text-gold transition-colors text-4xl z-10 px-3 py-2"
                onClick={(e) => { e.stopPropagation(); setLightboxIndex(lightboxIndex + 1) }}
